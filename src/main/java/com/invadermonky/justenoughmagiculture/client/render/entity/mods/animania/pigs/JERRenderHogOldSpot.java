...
public class JERRenderHogOldSpot extends RenderHogOldSpot {
    public static final JERRenderHogOldSpot.Factory FACTORY = new JERRenderHogOldSpot.Factory();

    public JERRenderHogOldSpot(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigOldSpot.EntityHogOldSpot> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderHogOldSpot(manager);
        }
    }
}
