...
public class RenderBuckHavanaJER extends RenderBuckHavana {
    public static final RenderBuckHavanaJER.Factory FACTORY = new RenderBuckHavanaJER.Factory();

    public RenderBuckHavanaJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitHavana.EntityRabbitBuckHavana> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderBuckHavanaJER(manager);
        }
    }
}
