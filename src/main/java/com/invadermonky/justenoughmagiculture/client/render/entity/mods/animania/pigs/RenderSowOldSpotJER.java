...
public class RenderSowOldSpotJER extends RenderSowOldSpot {
    public static final RenderSowOldSpotJER.Factory FACTORY = new RenderSowOldSpotJER.Factory();

    public RenderSowOldSpotJER(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(PigOldSpot.EntitySowOldSpot entity, float f) {
    ...
    static class Factory<T extends PigOldSpot.EntitySowOldSpot> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderSowOldSpotJER(manager);
        }
    }
}
