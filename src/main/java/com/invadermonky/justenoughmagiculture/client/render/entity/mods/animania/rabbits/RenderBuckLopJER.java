...
public class RenderBuckLopJER extends RenderBuckLop {
    public static final RenderBuckLopJER.Factory FACTORY = new RenderBuckLopJER.Factory();

    public RenderBuckLopJER(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(RabbitLop.EntityRabbitBuckLop entity, float f) {
    ...
    static class Factory<T extends RabbitLop.EntityRabbitBuckLop> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderBuckLopJER(manager);
        }
    }
}
