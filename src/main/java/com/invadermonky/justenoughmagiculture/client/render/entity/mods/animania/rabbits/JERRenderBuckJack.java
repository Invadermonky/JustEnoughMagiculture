...
public class JERRenderBuckJack extends RenderBuckJack {
    public static final JERRenderBuckJack.Factory FACTORY = new JERRenderBuckJack.Factory();

    public JERRenderBuckJack(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitJack.EntityRabbitBuckJack> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderBuckJack(manager);
        }
    }
}
