...
public class JERRenderSowLargeWhite extends RenderSowLargeWhite {
    public static final JERRenderSowLargeWhite.Factory FACTORY = new JERRenderSowLargeWhite.Factory();

    public JERRenderSowLargeWhite(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(PigLargeWhite.EntitySowLargeWhite entity, float f) {
    ...
    static class Factory<T extends PigLargeWhite.EntitySowLargeWhite> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderSowLargeWhite(manager);
        }
    }
}
