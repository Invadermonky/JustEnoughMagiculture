...
public class RenderDoeChinchillaJER extends RenderDoeChinchilla {
    public static final RenderDoeChinchillaJER.Factory FACTORY = new RenderDoeChinchillaJER.Factory();

    public RenderDoeChinchillaJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitChinchilla.EntityRabbitDoeChinchilla> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderDoeChinchillaJER(manager);
        }
    }
}
