...
public class RenderSowHampshireJER extends RenderSowHampshire {
    public static final RenderSowHampshireJER.Factory FACTORY = new RenderSowHampshireJER.Factory();

    public RenderSowHampshireJER(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(PigHampshire.EntitySowHampshire entity, float f) {
    ...
    static class Factory<T extends PigHampshire.EntitySowHampshire> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderSowHampshireJER(manager);
        }
    }
}
