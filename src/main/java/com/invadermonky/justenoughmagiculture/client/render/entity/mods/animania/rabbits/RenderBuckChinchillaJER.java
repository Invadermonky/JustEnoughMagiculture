...
public class RenderBuckChinchillaJER extends RenderBuckChinchilla {
    public static final RenderBuckChinchillaJER.Factory FACTORY = new RenderBuckChinchillaJER.Factory();

    public RenderBuckChinchillaJER(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(RabbitChinchilla.EntityRabbitBuckChinchilla entity, float f) {
    ...
    static class Factory<T extends RabbitChinchilla.EntityRabbitBuckChinchilla> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderBuckChinchillaJER(manager);
        }
    }
}
