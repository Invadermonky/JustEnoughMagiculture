...
public class RenderDoeHavanaJER extends RenderDoeHavana {
    public static final RenderDoeHavanaJER.Factory FACTORY = new RenderDoeHavanaJER.Factory();

    public RenderDoeHavanaJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitHavana.EntityRabbitDoeHavana> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderDoeHavanaJER(manager);
        }
    }
}
