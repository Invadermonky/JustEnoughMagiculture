...
public class JERRenderBuckLop extends RenderBuckLop {
    public static final JERRenderBuckLop.Factory FACTORY = new JERRenderBuckLop.Factory();

    public JERRenderBuckLop(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitLop.EntityRabbitBuckLop> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderBuckLop(manager);
        }
    }
}
