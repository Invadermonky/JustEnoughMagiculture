...
public class RenderSowLargeBlackJER extends RenderSowLargeBlack {
    public static final RenderSowLargeBlackJER.Factory FACTORY = new RenderSowLargeBlackJER.Factory();

    public RenderSowLargeBlackJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigLargeBlack.EntitySowLargeBlack> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderSowLargeBlackJER(manager);
        }
    }
}
