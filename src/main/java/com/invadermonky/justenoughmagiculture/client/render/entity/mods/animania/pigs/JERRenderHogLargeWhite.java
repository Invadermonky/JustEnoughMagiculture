...
public class JERRenderHogLargeWhite extends RenderHogLargeWhite {
    public static final JERRenderHogLargeWhite.Factory FACTORY = new JERRenderHogLargeWhite.Factory();

    public JERRenderHogLargeWhite(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigLargeWhite.EntityHogLargeWhite> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderHogLargeWhite(manager);
        }
    }
}
