...
public class JERRenderHogDuroc extends RenderHogDuroc {
    public static final JERRenderHogDuroc.Factory FACTORY = new JERRenderHogDuroc.Factory();

    public JERRenderHogDuroc(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(PigDuroc.EntityHogDuroc entity, float f) {
    ...
    static class Factory<T extends PigDuroc.EntityHogDuroc> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderHogDuroc(manager);
        }
    }
}
