...
public class JERRenderDoeRex extends RenderDoeRex {
    public static final JERRenderDoeRex.Factory FACTORY = new JERRenderDoeRex.Factory();

    public JERRenderDoeRex(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitRex.EntityRabbitDoeRex> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderDoeRex(manager);
        }
    }
}
