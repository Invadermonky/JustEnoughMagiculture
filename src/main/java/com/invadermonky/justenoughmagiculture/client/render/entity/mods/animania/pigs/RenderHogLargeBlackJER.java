...
public class RenderHogLargeBlackJER extends RenderHogLargeBlack {
    public static final RenderHogLargeBlackJER.Factory FACTORY = new RenderHogLargeBlackJER.Factory();

    public RenderHogLargeBlackJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigLargeBlack.EntityHogLargeBlack> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderHogLargeBlackJER(manager);
        }
    }
}
