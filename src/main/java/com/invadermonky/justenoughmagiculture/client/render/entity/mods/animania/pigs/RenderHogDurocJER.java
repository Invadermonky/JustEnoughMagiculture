...
public class RenderHogDurocJER extends RenderHogDuroc {
    public static final RenderHogDurocJER.Factory FACTORY = new RenderHogDurocJER.Factory();

    public RenderHogDurocJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigDuroc.EntityHogDuroc> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderHogDurocJER(manager);
        }
    }
}
