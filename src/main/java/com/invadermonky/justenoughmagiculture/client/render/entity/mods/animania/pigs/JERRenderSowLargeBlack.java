...
public class JERRenderSowLargeBlack extends RenderSowLargeBlack {
    public static final JERRenderSowLargeBlack.Factory FACTORY = new JERRenderSowLargeBlack.Factory();

    public JERRenderSowLargeBlack(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(PigLargeBlack.EntitySowLargeBlack entity, float f) {
    ...
    static class Factory<T extends PigLargeBlack.EntitySowLargeBlack> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderSowLargeBlack(manager);
        }
    }
}
