...
public class JERRenderBuckRex extends RenderBuckRex {
    public static final JERRenderBuckRex.Factory FACTORY = new JERRenderBuckRex.Factory();

    public JERRenderBuckRex(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitRex.EntityRabbitBuckRex> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderBuckRex(manager);
        }
    }
}
