...
public class JERRenderBuckNewZealand extends RenderBuckNewZealand {
    public static final JERRenderBuckNewZealand.Factory FACTORY = new JERRenderBuckNewZealand.Factory();

    public JERRenderBuckNewZealand(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(RabbitNewZealand.EntityRabbitBuckNewZealand entity, float f) {
    ...
    static class Factory<T extends RabbitNewZealand.EntityRabbitBuckNewZealand> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderBuckNewZealand(manager);
        }
    }
}
