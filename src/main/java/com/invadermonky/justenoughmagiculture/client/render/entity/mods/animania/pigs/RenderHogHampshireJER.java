...
public class RenderHogHampshireJER extends RenderHogHampshire {
    public static final RenderHogHampshireJER.Factory FACTORY = new RenderHogHampshireJER.Factory();

    public RenderHogHampshireJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigHampshire.EntityHogHampshire> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderHogHampshireJER(manager);
        }
    }
}
