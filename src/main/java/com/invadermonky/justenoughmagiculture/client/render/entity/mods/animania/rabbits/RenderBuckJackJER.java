...
public class RenderBuckJackJER extends RenderBuckJack {
    public static final RenderBuckJackJER.Factory FACTORY = new RenderBuckJackJER.Factory();

    public RenderBuckJackJER(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(RabbitJack.EntityRabbitBuckJack entity, float f) {
    ...
    static class Factory<T extends RabbitJack.EntityRabbitBuckJack> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderBuckJackJER(manager);
        }
    }
}
