...
public class JERRenderDoeDutch extends RenderDoeDutch {
    public static final JERRenderDoeDutch.Factory FACTORY = new JERRenderDoeDutch.Factory();

    public JERRenderDoeDutch(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitDutch.EntityRabbitDoeDutch> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderDoeDutch(manager);
        }
    }
}
