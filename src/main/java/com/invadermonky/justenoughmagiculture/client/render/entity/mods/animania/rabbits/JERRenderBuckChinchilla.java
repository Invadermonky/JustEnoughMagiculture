...
public class JERRenderBuckChinchilla extends RenderBuckChinchilla {
    public static final JERRenderBuckChinchilla.Factory FACTORY = new JERRenderBuckChinchilla.Factory();

    public JERRenderBuckChinchilla(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitChinchilla.EntityRabbitBuckChinchilla> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderBuckChinchilla(manager);
        }
    }
}
