...
public class RenderSowYorkshireJER extends RenderSowYorkshire {
    public static final RenderSowYorkshireJER.Factory FACTORY = new RenderSowYorkshireJER.Factory();

    public RenderSowYorkshireJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigYorkshire.EntitySowYorkshire> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderSowYorkshireJER(manager);
        }
    }
}
