...
public class JERRenderBuckCottontail extends RenderBuckCottontail {
    public static final JERRenderBuckCottontail.Factory FACTORY = new JERRenderBuckCottontail.Factory();

    public JERRenderBuckCottontail(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitCottonail.EntityRabbitBuckCottontail> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderBuckCottontail(manager);
        }
    }
}
