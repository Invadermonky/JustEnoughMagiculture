...
public class RenderDoeJackJER extends RenderDoeJack {
    public static final RenderDoeJackJER.Factory FACTORY = new RenderDoeJackJER.Factory();

    public RenderDoeJackJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitJack.EntityRabbitDoeJack> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderDoeJackJER(manager);
        }
    }
}
