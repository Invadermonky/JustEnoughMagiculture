...
public class RenderBuckNewZealandJER extends RenderBuckNewZealand {
    public static final RenderBuckNewZealandJER.Factory FACTORY = new RenderBuckNewZealandJER.Factory();

    public RenderBuckNewZealandJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitNewZealand.EntityRabbitBuckNewZealand> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderBuckNewZealandJER(manager);
        }
    }
}
