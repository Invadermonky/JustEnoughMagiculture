...
public class JERRenderSowYorkshire extends RenderSowYorkshire {
    public static final JERRenderSowYorkshire.Factory FACTORY = new JERRenderSowYorkshire.Factory();

    public JERRenderSowYorkshire(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(PigYorkshire.EntitySowYorkshire entity, float f) {
    ...
    static class Factory<T extends PigYorkshire.EntitySowYorkshire> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderSowYorkshire(manager);
        }
    }
}
