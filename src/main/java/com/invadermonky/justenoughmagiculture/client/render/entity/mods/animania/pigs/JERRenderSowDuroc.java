...
public class JERRenderSowDuroc extends RenderSowDuroc {
    public static final JERRenderSowDuroc.Factory FACTORY = new JERRenderSowDuroc.Factory();

    public JERRenderSowDuroc(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigDuroc.EntitySowDuroc> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderSowDuroc(manager);
        }
    }
}
