...
public class JERRenderHenBase extends RenderHenBase {
    public static final JERRenderHenBase.Factory FACTORY = new JERRenderHenBase.Factory();

    public JERRenderHenBase(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends JERRenderHenBase> implements IRenderFactory<EntityHenBase> {
        Factory() {}

        public Render<? super EntityHenBase> createRenderFor(RenderManager manager) {
            return new JERRenderHenBase(manager);
        }
    }
