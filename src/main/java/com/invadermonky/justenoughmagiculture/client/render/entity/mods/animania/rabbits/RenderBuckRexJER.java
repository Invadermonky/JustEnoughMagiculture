...
public class RenderBuckRexJER extends RenderBuckRex {
    public static final RenderBuckRexJER.Factory FACTORY = new RenderBuckRexJER.Factory();

    public RenderBuckRexJER(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(RabbitRex.EntityRabbitBuckRex entity, float f) {
    ...
    static class Factory<T extends RabbitRex.EntityRabbitBuckRex> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderBuckRexJER(manager);
        }
    }
}
