...
public class RenderSowLargeWhiteJER extends RenderSowLargeWhite {
    public static final RenderSowLargeWhiteJER.Factory FACTORY = new RenderSowLargeWhiteJER.Factory();

    public RenderSowLargeWhiteJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigLargeWhite.EntitySowLargeWhite> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderSowLargeWhiteJER(manager);
        }
    }
}
