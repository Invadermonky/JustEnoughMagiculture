...
public class RenderDoeCottontailJER extends RenderDoeCottontail {
    public static final RenderDoeCottontailJER.Factory FACTORY = new RenderDoeCottontailJER.Factory();

    public RenderDoeCottontailJER(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(RabbitCottonail.EntityRabbitDoeCottontail entity, float f) {
    ...
    static class Factory<T extends RabbitCottonail.EntityRabbitDoeCottontail> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderDoeCottontailJER(manager);
        }
    }
}
