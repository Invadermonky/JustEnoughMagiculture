...
public class RenderDoeDutchJER extends RenderDoeDutch {
    public static final RenderDoeDutchJER.Factory FACTORY = new RenderDoeDutchJER.Factory();

    public RenderDoeDutchJER(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(RabbitDutch.EntityRabbitDoeDutch entity, float f) {
    ...
    static class Factory<T extends RabbitDutch.EntityRabbitDoeDutch> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderDoeDutchJER(manager);
        }
    }
}
