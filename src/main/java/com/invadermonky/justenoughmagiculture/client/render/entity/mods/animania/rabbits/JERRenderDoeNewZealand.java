...
public class JERRenderDoeNewZealand extends RenderDoeNewZealand {
    public static final JERRenderDoeNewZealand.Factory FACTORY = new JERRenderDoeNewZealand.Factory();

    public JERRenderDoeNewZealand(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(RabbitNewZealand.EntityRabbitDoeNewZealand entity, float f) {
    ...
    static class Factory<T extends RabbitNewZealand.EntityRabbitDoeNewZealand> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderDoeNewZealand(manager);
        }
    }
}
