...
public class JERRenderDoeLop extends RenderDoeLop {
    public static final JERRenderDoeLop.Factory FACTORY = new JERRenderDoeLop.Factory();

    public JERRenderDoeLop(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitLop.EntityRabbitDoeLop> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderDoeLop(manager);
        }
    }
}
