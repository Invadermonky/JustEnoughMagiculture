...
public class JERRenderSowHampshire extends RenderSowHampshire {
    public static final JERRenderSowHampshire.Factory FACTORY = new JERRenderSowHampshire.Factory();

    public JERRenderSowHampshire(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigHampshire.EntitySowHampshire> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderSowHampshire(manager);
        }
    }
}
