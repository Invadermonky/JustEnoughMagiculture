...
public class RenderBuckCottontailJER extends RenderBuckCottontail {
    public static final RenderBuckCottontailJER.Factory FACTORY = new RenderBuckCottontailJER.Factory();

    public RenderBuckCottontailJER(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(RabbitCottonail.EntityRabbitBuckCottontail entity, float f) {
    ...
    static class Factory<T extends RabbitCottonail.EntityRabbitBuckCottontail> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderBuckCottontailJER(manager);
        }
    }
}
