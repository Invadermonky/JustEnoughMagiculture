...
public class RenderBuckDutchJER extends RenderBuckDutch {
    public static final RenderBuckDutchJER.Factory FACTORY = new RenderBuckDutchJER.Factory();

    public RenderBuckDutchJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitDutch.EntityRabbitBuckDutch> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderBuckDutchJER(manager);
        }
    }
}
