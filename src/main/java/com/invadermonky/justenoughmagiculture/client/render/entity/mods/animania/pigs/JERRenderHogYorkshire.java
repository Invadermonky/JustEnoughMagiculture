...
public class JERRenderHogYorkshire extends RenderHogYorkshire {
    public static final JERRenderHogYorkshire.Factory FACTORY = new JERRenderHogYorkshire.Factory();

    public JERRenderHogYorkshire(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(PigYorkshire.EntityHogYorkshire entity, float f) {
    ...
    static class Factory<T extends PigYorkshire.EntityHogYorkshire> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderHogYorkshire(manager);
        }
    }
}
