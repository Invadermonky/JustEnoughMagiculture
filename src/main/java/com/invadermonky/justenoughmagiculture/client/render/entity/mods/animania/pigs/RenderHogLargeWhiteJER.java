...
public class RenderHogLargeWhiteJER extends RenderHogLargeWhite {
    public static final RenderHogLargeWhiteJER.Factory FACTORY = new RenderHogLargeWhiteJER.Factory();

    public RenderHogLargeWhiteJER(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(PigLargeWhite.EntityHogLargeWhite entity, float f) {
    ...
    static class Factory<T extends PigLargeWhite.EntityHogLargeWhite> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderHogLargeWhiteJER(manager);
        }
    }
}
