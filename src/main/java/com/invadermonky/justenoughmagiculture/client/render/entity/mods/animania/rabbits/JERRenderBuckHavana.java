...
public class JERRenderBuckHavana extends RenderBuckHavana {
    public static final JERRenderBuckHavana.Factory FACTORY = new JERRenderBuckHavana.Factory();

    public JERRenderBuckHavana(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(RabbitHavana.EntityRabbitBuckHavana entity, float f) {
    ...
    static class Factory<T extends RabbitHavana.EntityRabbitBuckHavana> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderBuckHavana(manager);
        }
    }
}
