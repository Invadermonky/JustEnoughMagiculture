...
public class JERRenderHogHampshire extends RenderHogHampshire {
    public static final JERRenderHogHampshire.Factory FACTORY = new JERRenderHogHampshire.Factory();

    public JERRenderHogHampshire(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(PigHampshire.EntityHogHampshire entity, float f) {
    ...
    static class Factory<T extends PigHampshire.EntityHogHampshire> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderHogHampshire(manager);
        }
    }
}
