...
public class JERRenderSowOldSpot extends RenderSowOldSpot {
    public static final JERRenderSowOldSpot.Factory FACTORY = new JERRenderSowOldSpot.Factory();

    public JERRenderSowOldSpot(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigOldSpot.EntitySowOldSpot> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderSowOldSpot(manager);
        }
    }
}
