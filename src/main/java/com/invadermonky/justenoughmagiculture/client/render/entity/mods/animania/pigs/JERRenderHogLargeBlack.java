...
public class JERRenderHogLargeBlack extends RenderHogLargeBlack {
    public static final JERRenderHogLargeBlack.Factory FACTORY = new JERRenderHogLargeBlack.Factory();

    public JERRenderHogLargeBlack(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(PigLargeBlack.EntityHogLargeBlack entity, float f) {
    ...
    static class Factory<T extends PigLargeBlack.EntityHogLargeBlack> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderHogLargeBlack(manager);
        }
    }
}
