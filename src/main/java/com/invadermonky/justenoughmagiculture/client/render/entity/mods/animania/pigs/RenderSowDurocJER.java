...
public class RenderSowDurocJER extends RenderSowDuroc {
    public static final RenderSowDurocJER.Factory FACTORY = new RenderSowDurocJER.Factory();

    public RenderSowDurocJER(RenderManager rm) {
        super(rm);
    }

    @Override
    protected void preRenderScale(PigDuroc.EntitySowDuroc entity, float f) {
    ...
    static class Factory<T extends PigDuroc.EntitySowDuroc> implements IRenderFactory<T> {
        Factory() {}

        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderSowDurocJER(manager);
        }
    }
}
