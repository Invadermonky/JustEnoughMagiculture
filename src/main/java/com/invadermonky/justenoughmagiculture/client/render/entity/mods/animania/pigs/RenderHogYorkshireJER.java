...
public class RenderHogYorkshireJER extends RenderHogYorkshire {
    public static final RenderHogYorkshireJER.Factory FACTORY = new RenderHogYorkshireJER.Factory();

    public RenderHogYorkshireJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends PigYorkshire.EntityHogYorkshire> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderHogYorkshireJER(manager);
        }
    }
}
