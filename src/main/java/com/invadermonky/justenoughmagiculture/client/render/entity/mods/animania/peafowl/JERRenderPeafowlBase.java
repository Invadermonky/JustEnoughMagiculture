...
public class JERRenderPeafowlBase extends RenderPeafowlBase {
    public static final JERRenderPeafowlBase.Factory FACTORY = new JERRenderPeafowlBase.Factory();

    public JERRenderPeafowlBase(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends EntityPeafowlBase> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderPeafowlBase(manager);
        }
    }
}
