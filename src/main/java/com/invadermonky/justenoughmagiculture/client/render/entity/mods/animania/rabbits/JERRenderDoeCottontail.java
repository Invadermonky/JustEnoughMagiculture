...
public class JERRenderDoeCottontail extends RenderDoeCottontail {
    public static final JERRenderDoeCottontail.Factory FACTORY = new JERRenderDoeCottontail.Factory();

    public JERRenderDoeCottontail(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitCottonail.EntityRabbitDoeCottontail> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new JERRenderDoeCottontail(manager);
        }
    }
}
