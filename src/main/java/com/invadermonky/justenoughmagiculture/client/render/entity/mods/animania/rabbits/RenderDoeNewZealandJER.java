...
public class RenderDoeNewZealandJER extends RenderDoeNewZealand {
    public static final RenderDoeNewZealandJER.Factory FACTORY = new RenderDoeNewZealandJER.Factory();

    public RenderDoeNewZealandJER(RenderManager rm) {
        super(rm);
    }
    ...
    static class Factory<T extends RabbitNewZealand.EntityRabbitDoeNewZealand> implements IRenderFactory<T> {
        ...
        public Render<? super T> createRenderFor(RenderManager manager) {
            return new RenderDoeNewZealandJER(manager);
        }
    }
}
