...
public class JEMConfigSpecialMobs {
    private static final String MOD_NAME = ConstantNames.SPECIAL_MOBS;
    ...
    public static class JER {
        @Comment("Enter the unlocalized name of the mob you wish to remove from JER Integration. Example: DarkCreeper")
        public String[] disableMobs = new String[0];
    }
}
