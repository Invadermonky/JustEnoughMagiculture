...
public class JEMConfigRusticThaumaturgy {
    private static final String MOD_NAME = ConstantNames.RUSTIC_THAUMATURGY;
    ...
    public static class JER {
        public boolean enableCindermote = true;
        public boolean enableShimmerpetal = true;
        public boolean enableViscap = true;
    }
}
