...
https://www.curseforge.com/minecraft/mc-mods/just-enough-magiculture
...
### Mobs
- Polar Bear
- Wither (This uses a fake loot table to generate the JER page, so you can modify the table like any other to display additional drops.)
...
### Villagers
- Pigtificate Armorsmith
- Pigtificate Brewer
- Pigtificate Chief
- Pigtificate Enchanter
- Pigtificate Gatherer
- Pigtificate Hunter
- Pigtificate Nincompoop
- Pigtificate Scavenger
- Pigtificate Toolsmith
> JEM NetherEx Pigtificate integration supports trades modified using global trade tables.
> JEM does **NOT** support world specific trade tables.
> 
> To ensure proper functionality when using custom trade tables be sure to use the following config settings:
> 
> `B:useGlobalTradeConfigs=true`\
> `B:usePerWorldTradeConfigs=false`
...
### Injected loot drops
- Black Ash (Wither and Wither Skeleton)
- Witch Hat
...
### Dungeons
- Burial Mound
- Crate (Common, Uncommon and Rare)
- Urn (Common, Uncommon and Rare)

### Mobs
- **Bosses** - Disabled by default unless Crimson Warfare is installed. Can be force loaded.
  - Cultist Praetor
  - Greater Crimson Portal
  - Eldritch Golem
  - Eldritch Warden
...
- **Monsters**
  - Angry Zombie
  - Eldrich Crab (Disabled by default unless Thaumic Augmentation is installed. Can be force loaded.)
  - Fire Bat
  - Furious Zombie
  - Pech
  - Thaumic Slime
...
### Dungeons
- Eldritch Urn (Common, Uncommon and Rare)
- Eldritch Pedestal (Common, Uncommon and Rare)
